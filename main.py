...
def create_level(characters, items_list):
    ...
    #board, coliders = engine.put_stuff_on_board(board,items_list,BOARD_WIDTH,BOARD_HEIGHT,coliders)
...
def main():
    ...
    inhabitant = nemo
    board, player_position, door_1, door_2, door_3, door_4  = create_level([characters], [items.items_level_1[0][3]])  #print_boss_stats(boss) # umieścić nad boss roomem
    ...
    while True:
        util.clear_screen()
        print_player_stats(player) # umieścić nad całym bordem (zawsze widoczne)
